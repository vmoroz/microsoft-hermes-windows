...
static void Destructor(node_api_basic_env env, void *data, void *nothing) {
...
static void NoDeleteDestructor(node_api_basic_env env, void *data, void *hint) {
  napi_ref *ref = (napi_ref *)data;
...
static napi_value New(napi_env env, napi_callback_info info) {
  ...
  NODE_API_CALL(
      env, napi_get_cb_info(env, info, &argc, &js_delete, &js_this, NULL));
  NODE_API_CALL(env, napi_get_value_bool(env, js_delete, &should_delete));
...
napi_value Init(napi_env env, napi_value exports) {
  ...
  NODE_API_CALL(
      env, napi_set_named_property(env, exports, "MyObject", myobj_ctor));
  return exports;
}
EXTERN_C_END
