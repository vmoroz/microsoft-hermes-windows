...

{
  ...
  assert.throws(() => {
    obj.w = 'd';
  }, /(Cannot add property w, object is not extensible)|(TypeError: Cannot add new property 'w')/);
...

{
  ...
  assert.throws(() => {
    obj.x = 10;
  }, /(Cannot assign to read only property 'x' of object '#<Object>)|(TypeError: Cannot assign to read-only property 'x')/);
