...
TEST_P(NodeApiTest, test_basics_jsr_config) {
...
TEST_P(NodeApiTest, test_basics_CreateStringLatin1) {
...
TEST_P(NodeApiTest, test_basics_CreateStringLatin1_2) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
    napi_value str;
...
TEST_P(NodeApiTest, test_basics_CreateStringUTF8) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
    napi_value str;
...
TEST_P(NodeApiTest, test_basics_CreateStringUTF16) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
    napi_value str;
...
TEST_P(NodeApiTest, test_basics_RunScript) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
    napi_value script;
    ASSERT_EQ(
        napi_ok,
...
TEST_P(NodeApiTest, test_basics_HostFunctionTest) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
    bool isCalled{false};
    napi_value func;
    ASSERT_EQ(
...
TEST_P(NodeApiTest, test_basics_PropertyNamedGetSetTest) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
    napi_value obj{};
...
TEST_P(NodeApiTest, test_basics_PropertyStringGetSetTest) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
    napi_value obj{};
    ASSERT_EQ(napi_ok, napi_create_object(env, &obj));
...
TEST_P(NodeApiTest, test_basics_CreateStringType) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
    napi_value str{};
    ASSERT_EQ(
        napi_ok,
...
TEST_P(NodeApiTest, test_basics_CreateSymbolByScript) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
    napi_value script;
    ASSERT_EQ(
        napi_ok,
...
TEST_P(NodeApiTest, test_basics_CreateSymbol) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
    napi_value symDesc{};
    ASSERT_EQ(
        napi_ok,
...
TEST_P(NodeApiTest, test_basics_PropertySymbolGetSetTest) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
    napi_value obj{};
    ASSERT_EQ(napi_ok, napi_create_object(env, &obj));
...
TEST_P(NodeApiTest, test_basics_ExternalValueTest) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
    napi_value external{};
...
TEST_P(NodeApiTest, test_basics_ExternalValue2Test) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
...
TEST_P(NodeApiTest, test_basics_ExternalValue3Test) {
  bool finalizeRan{};
...
TEST_P(NodeApiTest, test_basics_ExternalValue4Test) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
    auto native_ptr = std::make_unique<int>(5);
    bool finalizeRan{};
...
TEST_P(NodeApiTest, test_basics_DateValueTest) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
    napi_value date{};
...
TEST_P(NodeApiTest, test_basics_DateValueNaNTest) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
    napi_value date{};
    ASSERT_EQ(
        napi_ok,
...
TEST_P(NodeApiTest, test_basics_PromisePropertyTest) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
    napi_value global{};
    ASSERT_EQ(napi_ok, napi_get_global(env, &global));
...
TEST_P(NodeApiTest, test_basics_NewInstanceTest) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
    napi_value script;
    ASSERT_EQ(
        napi_ok,
...
TEST_P(NodeApiTest, test_basics_ArrayTest) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
    napi_value arr;
...
TEST_P(NodeApiTest, test_basics_Finalizer) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
    auto native_ptr = std::make_unique<int>(5);
    bool finalizeRan{};
    {
...
TEST_P(NodeApiTest, test_basics_Wrap) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
    auto native_ptr = std::make_unique<int>(5);
    bool finalizeRan{};
    {
...
TEST_P(NodeApiTest, test_basics_Wrap2) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
    bool finalizeRan{};
    {
      napi_handle_scope scope{};
...
TEST_P(NodeApiTest, test_basics_BigIntWords) {
  ExecuteNodeApi([](NodeApiTestContext * /*testContext*/, napi_env env) {
    napi_value script;
    ASSERT_EQ(
        napi_ok,
