...
class HermesRuntimeAgentDelegate::Impl final : public RuntimeAgentDelegate {
  ...
  using HermesSessionConfig =
    hermes::inspector_modern::chrome::CDPHandlerSessionConfig;
 ...
 public:
  ...
  Impl(
      ...
      : hermes_(HermesCDPHandler::create(
            ...
            HermesSessionConfig{sessionState.isRuntimeDomainEnabled},
            HermesExecutionContextDescription{
                executionContextDescription.id,
                executionContextDescription.origin,
                executionContextDescription.name,
                std::nullopt,
                false})) {
