...
extern SHNativeFuncInfo s_function_info_table[];
  ...
  if (options.format == DumpBytecode || options.format == EmitBundle) {
    ...
    OS << "  SHCompressedPointer object_literal_class_cache["
       ...
       << "  unit_data->unit.index = &unit_index;\n"
       << "  unit_data->unit.num_symbols = " << moduleGen.stringTable.size() << ";\n"
       ...
       << "  unit_data->unit.read_prop_cache = unit_data->read_prop_cache_data;\n"
       << "  unit_data->unit.private_name_cache = unit_data->private_name_cache_data;\n"
       << "  unit_data->unit.obj_key_buffer = s_obj_key_buffer;\n"
       << "  unit_data->unit.obj_key_buffer_size = "
       << moduleGen.literalBuffers.objKeyBuffer.size() << ";\n"
       << "  unit_data->unit.literal_val_buffer = s_literal_val_buffer;\n"
       << "  unit_data->unit.literal_val_buffer_size = "
       << moduleGen.literalBuffers.literalValueBuffer.size() << ";\n"
       << "  unit_data->unit.obj_shape_table = s_obj_shape_table;\n"
       << "  unit_data->unit.obj_shape_table_count = "
       << moduleGen.literalBuffers.objShapeTable.size() << ";\n"
       << "  unit_data->unit.object_literal_class_cache = unit_data->object_literal_class_cache;\n"
       << "  unit_data->unit.source_locations = s_source_locations;\n"
       << "  unit_data->unit.source_locations_size = " << moduleGen.srcLocationTable.size() << ";\n"
       << "  unit_data->unit.unit_main = _0_global;\n"
       << "  unit_data->unit.unit_main_info = &s_function_info_table[0];\n"
       << "  unit_data->unit.unit_name = \"sh_compiled\";\n"
